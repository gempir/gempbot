import { ActionIcon, Card, Group, Loader, Pagination, Stack, Table as MantineTable, Text, Title, Tooltip } from '@mantine/core';
...
export function Table({ title, history, page, totalPages, loading, onPageChange, onApprove, onDeny }: TableProps) {
                        ...
                        <MantineTable highlightOnHover>
                            <MantineTable.Thead>
                                <MantineTable.Tr>
                                    ...
                                    {(onApprove || onDeny) && <MantineTable.Th w={100}>Actions</MantineTable.Th>}
                                </MantineTable.Tr>
                            </MantineTable.Thead>
                            <MantineTable.Tbody>
                                {history.map((item, index) => (
                                    <MantineTable.Tr key={index}>
                                        ...
                                        <MantineTable.Td>
                                            <Text size="sm" ff="monospace">{item.emoteID}</Text>
                                        </MantineTable.Td>
                                        <MantineTable.Td>
                                        ...
                                        <MantineTable.Td>
                                            <Text size="sm" c={item.changeType === 'ADD' ? 'green' : 'red'}>
                                                {item.changeType}
                                            </Text>
                                        </MantineTable.Td>
                                        {(onApprove || onDeny) && (
