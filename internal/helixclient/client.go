...
var scopes = []string{"channel:read:redemptions", "channel:manage:redemptions", "channel:read:predictions", "channel:manage:predictions", "moderation:read", "channel:bot", "moderator:manage:announcements"}
