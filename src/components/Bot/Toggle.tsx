...
export function Toggle({ checked, onChange }: { checked: boolean, onChange: (checked: boolean) => void }) {
    return <div className="flex flex-col justify-center items-center">
        {!checked && <div className="flex justify-center items-center" onClick={() => onChange(!checked)}>
        ...
        {checked &&
            <div className="flex justify-center items-center" onClick={() => onChange(!checked)}>
